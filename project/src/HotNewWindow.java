...
public class HotNewWindow extends JFrame implements ActionListener {
    ...
    ImageIcon ımage = new ImageIcon("hot.png");
    ...
    HotNewWindow(){
        ...
        infopanel.setBackground(new Color(0x3d3118));
        ...
        planetinfopanel.setBackground(new Color(0x3d3118));
        ...
        this.getContentPane().setBackground((new Color(0x54331c)));
		this.setLayout(null);
