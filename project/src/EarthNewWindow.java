...
public class EarthNewWindow extends JFrame implements ActionListener {
    ...
    ImageIcon ımage = new ImageIcon("earth.png");
    ...
    EarthNewWindow(){
        ...
        infopanel.setBackground(new Color(0x904b6b));
        ...
        planetinfopanel.setBackground(new Color(0x904b6b));
        ...
        errorgroundpanel.setBackground(new Color(0x101f26));
        ...
        this.getContentPane().setBackground((new Color(0x0a2830)));
		this.setLayout(null);
